...
import { Search, X, Eye, RotateCw } from "lucide-react";
				...
				<div className="flex items-center gap-3">
					...
					{onRefresh && (
						<button
							...
							className="p-1.5 rounded-lg text-emerald-800 hover:bg-emerald-200/60 transition-colors cursor-pointer"
						...
						{cases.length === 0 ? (
							<tr>
								<td colSpan={5} className="empty-state">
									No case records found. Fill out the form above and click
									&quot;Add Case&quot; to register a record.
								</td>
							</tr>
							...
							filteredCases.map((c) => (
								<tr key={c.id}>
									...
									<td>
										<strong>Animal Status: {c.animalStatus || "N/A"}</strong>
										<br />
										<br />
